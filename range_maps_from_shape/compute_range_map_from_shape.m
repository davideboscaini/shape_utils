function [shape_out,depth,idxs] = compute_range_map_from_shape(shape_in,params)
...
[M,depth,matches] = create_rangemap_from_shape(S,params.width,params.height,params);
...
% uncomment the following 4 lines to obtain the original code:
shape_out.X    =  shape.Y;
shape_out.Y    =  shape.X;
shape_out.Z    = -shape.Z;
shape_out.TRIV =  shape.TRIV;
